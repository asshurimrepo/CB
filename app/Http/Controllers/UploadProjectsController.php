...
class UploadProjectsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $commands = [
            "ffmpeg -i {$file->getPathname()} -vcodec libx264 -vprofile high -preset veryslow -b:v 225k -maxrate 300k -bufsize 1000k -vf scale=-1:720 -threads 2 -acodec aac -b:a 128k -f mp4 data/{$user->email}/done/{$file->getFilename()}",
