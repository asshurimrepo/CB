	...
	methods: {
		...
		playProject: function playProject() {
			...
			setTimeout(function () {
				...
				_this2.video.play();
				_this2.video_duration = Math.floor(_this2.video.duration()) * 1000;
			}, delay);
