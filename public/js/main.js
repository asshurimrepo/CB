...
},{"../templates/options.html":7}],5:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	methods: {
		...
		deleteMe: function deleteMe() {
			...
			this.$http.delete('/project/' + this.id).then(function () {
...
},{"../templates/project.html":8}],6:[function(require,module,exports){
'use strict';
...
new _vue2.default({
	...
	components: {
		Project: _Project2.default, ProjectOptions: _Options2.default
	},
