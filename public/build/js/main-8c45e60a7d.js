	...
	ready: function ready() {
		...
		this.video.on("timeupdate", function () {
			...
			if (_this.textoverlaystart > _this.vidduration) {
				...
				if (_this.vidtime === _this.textoverlaystart) {
					$("#project-text-overlay").fadeIn("fast", function () {
						if (_this.textoverlayduration > 0) {
							setTimeout(function () {
								$("#project-text-overlay").fadeOut("fast");
			...
			if (_this.clicktocallstart > _this.vidduration) {

				if (_this.vidtime === _this.vidduration) {
					$("#project-clicktocall").fadeIn("fast", function () {
						if (_this.clicktocallduration > 0) {
							setTimeout(function () {
								$("#project-clicktocall").fadeOut("fast");
							}, _this.clicktocallduration);
						}
					});
					return false;
				}
				...
				if (_this.vidtime === _this.clicktocallstart) {
					$("#project-clicktocall").fadeIn("fast", function () {
						if (_this.clicktocallduration > 0) {
							setTimeout(function () {
								$("#project-clicktocall").fadeOut("fast");
			...
			if (_this.buttonoverlaystart > _this.vidduration) {

				if (_this.vidtime === _this.vidduration) {
					$("#project-buttonoverlay").fadeIn("fast", function () {
						if (_this.buttonoverlayduration > 0) {
							setTimeout(function () {
								$("#project-buttonoverlay").fadeOut("fast");
							}, _this.buttonoverlayduration);
						}
					});
					return false;
				}
				...
				if (_this.vidtime === _this.buttonoverlaystart) {
					$("#project-buttonoverlay").fadeIn("fast", function () {
						if (_this.buttonoverlayduration > 0) {
							setTimeout(function () {
								$("#project-buttonoverlay").fadeOut("fast");
			...
			if (_this.formoverlaystart > _this.vidduration) {

				if (_this.vidtime === _this.vidduration) {
					$("#project-formoverlay").fadeIn("fast", function () {
						if (_this.formoverlayduration > 0) {
							setTimeout(function () {
								$("#project-formoverlay").fadeOut("fast");
							}, _this.formoverlayduration);
						}
					});
					return false;
				}
				...
				if (_this.vidtime === _this.formoverlaystart) {
					$("#project-formoverlay").fadeIn("fast", function () {
						if (_this.formoverlayduration > 0) {
							setTimeout(function () {
								$("#project-formoverlay").fadeOut("fast");
	...
	methods: {
		...
		playProject: function playProject() {
			...
			setTimeout(function () {
				...
				_this3.video.play();
				_this3.vidduration = Math.floor(_this3.video.duration());
			}, delay);
