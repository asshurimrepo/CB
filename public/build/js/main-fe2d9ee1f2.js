...
exports.default = {
	...
	methods: {
		...
		playProject: function playProject() {
			...
			$("body").on("click", "a.close-project", function () {
				_this2.video.pause();
				$('#project-player-bg').hide();
			});
		},
		projectOptions: function projectOptions() {
			var exit = this.project.options.stop_showing.exit_on_end;
			var closed_click = this.project.options.stop_showing.clicked;
			...
			if (closed_click) {
				$("#project-player-container").on("click", function () {
					$("#project-player-bg").hide();
				});
			}
		},
